...
<body>
    <div class="container">
        ...
        <p>Congratulations! <b style="color:green">You have accepted</b> into the <b>{{$program->name}} Program</b>. To proceed, please create an account on SIM Global UNAIR using the following username:</p>
        <span class="username">{{$username}}</span>
        <p>Please verify your sim.go.ac.id account by clicking the button below:</p>
        <a href="{{route('verify.codebase', ['encryptedUsername'=>$encryptedUsername])}}" class="button">Set Personal Password</a>
        ...
        <hr>
        <p><b>For further inquiries, please contact your PIC:</b></p>
        <p>{{$program->pic}} (<a href="{{$program->corresponding}}">{{$program->corresponding}}</a>)</p>
