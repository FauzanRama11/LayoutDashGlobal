	                ...
	                <div class="card-body">
	                    <div class="table-responsive">
	                        <table class="display" id="API-2">
								<a href="{{ route('li_form_periode.create') }}">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="{{ route('li_form_periode.edit', ['id' => $item->id]) }}" class="btn btn-primary btn-sm">Edit</a>
										</td>
										<td>
											<form action="{{ route('li_hapus_periode', ['id' => $item->id]) }}" method="POST">
												@csrf
												@method('DELETE')
