...
@section('title')Template RPS | Amerta
@endsection
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="display" id="API-2">
                                    <a href="{{ route('am_form_rps.create') }}">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('am_form_rps.edit', ['id' => $item->id]) }}" class="btn btn-primary btn-sm">Edit</a>
                                            </td>
                                            <td>
                                                <form action="{{ route('am_hapus_rps', ['id' => $item->id]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
