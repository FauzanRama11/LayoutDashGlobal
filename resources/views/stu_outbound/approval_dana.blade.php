...
return $(tableId).DataTable({
    order: [ ],
        ...
        paging: true,
        ajax: {
            url: "{{ route('stuout_approval_dana') }}",
            type: 'GET'
        },
		columns: [
    ...
    { data: 'nama', name: 'nama' },
    { data: 'host_unit_text', name: 'm_stu_out_programs.host_unit_text' },
    { data: 'program', name: 'm_stu_out_programs.name'},
    { data: 'tipe', name: 'm_stu_out_programs.pt_ft'},
